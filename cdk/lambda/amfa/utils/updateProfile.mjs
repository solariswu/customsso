...
export const updateProfile = async (email, otptype, profile, logoUrl, serviceName, cognitoClient) => {
	...
	await notifyProfileChange(email, [profileTypes[otptype]], [profile], logoUrl, serviceName, false);
