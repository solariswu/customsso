export const config = {
	'amfa-dev004':
	{
		...
		'callbackUrls': ['https://amfa-awsdemo-userportal.netlify.app/auth-callback', 'https://amfa.netlify.app/', 'https://apersona.netlify.app/auth-callback', 'http://localhost:3000'],
