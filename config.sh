...
export INSTALLER_EMAIL='' ## example ‘devadmin@yourdomain.com', will use ADMIN_EMAIL if not set.
...
# This value should be a 24 to 32 character string
export ASM_SALT='' ## example '1234567890abcedfABCDEFGH'